...
const Dashboard = () => {
  ...
  // Single useEffect to handle all filtering (gender + category)
  useEffect(() => {
    const fetchCandidates = async () => {
      try {
        let url = 'https://atomicabackend.onrender.com/api/candidates';
        let params = {};
        ...
        if (searchGender) {
          // If gender is selected, use gender-specific endpoint
          url = `https://atomicabackend.onrender.com/api/candidates/gender/${searchGender}`;
        }
  ...
  // Keep client-side age + ID filtering
